...
/**
 * This is the item provider adapter for a {@link Juri.Library} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LibraryItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 JuriPackage.Literals.LIBRARY__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(JuriPackage.Literals.LIBRARY__BOOKS);
			childrenFeatures.add(JuriPackage.Literals.LIBRARY__LOANS);
			childrenFeatures.add(JuriPackage.Literals.LIBRARY__MEMBERS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(JuriPackage.Literals.LIBRARY__BOOKS,
				 JuriFactory.eINSTANCE.createBook()));

		newChildDescriptors.add
			(createChildParameter
				(JuriPackage.Literals.LIBRARY__LOANS,
				 JuriFactory.eINSTANCE.createLoan()));

		newChildDescriptors.add
			(createChildParameter
				(JuriPackage.Literals.LIBRARY__MEMBERS,
				 JuriFactory.eINSTANCE.createMember()));
	}
