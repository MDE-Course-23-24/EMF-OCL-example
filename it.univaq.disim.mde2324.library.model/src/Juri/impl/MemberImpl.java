 ...
 * </p>
 * <ul>
 *   <li>{@link Juri.impl.MemberImpl#getName <em>Name</em>}</li>
 *   <li>{@link Juri.impl.MemberImpl#getLibrary <em>Library</em>}</li>
 *   <li>{@link Juri.impl.MemberImpl#getLoan <em>Loan</em>}</li>
 *   <li>{@link Juri.impl.MemberImpl#getLoans <em>Loans</em>}</li>
 *   <li>{@link Juri.impl.MemberImpl#getBooks <em>Books</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MemberImpl extends MinimalEObjectImpl.Container implements Member {
	...
	protected EClass eStaticClass() {
		return JuriPackage.Literals.MEMBER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JuriPackage.MEMBER__NAME, oldName, name));
	}
	...
	public Library getLibrary() {
		if (eContainerFeatureID() != JuriPackage.MEMBER__LIBRARY) return null;
	...
	public NotificationChain basicSetLibrary(Library newLibrary, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newLibrary, JuriPackage.MEMBER__LIBRARY, msgs);
		return msgs;
	}
	...
	public void setLibrary(Library newLibrary) {
		if (newLibrary != eInternalContainer() || (eContainerFeatureID() != JuriPackage.MEMBER__LIBRARY && newLibrary != null)) {
			...
			if (newLibrary != null)
				msgs = ((InternalEObject)newLibrary).eInverseAdd(this, JuriPackage.LIBRARY__MEMBERS, Library.class, msgs);
			msgs = basicSetLibrary(newLibrary, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JuriPackage.MEMBER__LIBRARY, newLibrary, newLibrary));
	}
	...
	public EList<Loan> getLoan() {
		if (loan == null) {
			loan = new EObjectWithInverseResolvingEList<Loan>(Loan.class, this, JuriPackage.MEMBER__LOAN, JuriPackage.LOAN__MEMBER);
		}
		return loan;
	}
	...
	public EList<Loan> getLoans() {
		...
		while (true) {
			 ...
			 */
			if (_1 == null) {
				throw new InvalidValueException("Null source for \'\'http://www.eclipse.org/jj\'::Loan::member\'");
			}
	...
	public EList<Book> getBooks() {
		...
		/*@Thrown*/ org.eclipse.ocl.pivot.values.BagValue.Accumulator accumulator = ValueUtil.createBagAccumulatorValue(JuriTables.BAG_CLSSid_Book_0);
		Iterator<Object> ITERATOR__1 = BOXED_loans.iterator();
	...
	public boolean AtMostTwoLoans(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			final /*@NonInvalid*/ Executor executor = PivotUtil.getExecutor(this);
			final /*@NonInvalid*/ IdResolver idResolver = executor.getIdResolver();
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, JuriPackage.Literals.MEMBER___AT_MOST_TWO_LOANS__DIAGNOSTICCHAIN_MAP);
			...
			if (le) {
				...
				final /*@NonInvalid*/ boolean result = OclComparableLessThanEqualOperation.INSTANCE.evaluate(executor, size, JuriTables.INT_2).booleanValue();
				final /*@NonInvalid*/ boolean logDiagnostic = CGStringLogDiagnosticOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, constraintName, this, (Object)null, diagnostics, context, (Object)null, severity_0, result, JuriTables.INT_0).booleanValue();
				IF_le = logDiagnostic;
			}
			return IF_le;
		}
	...
	public boolean UniqueLoans(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			final /*@NonInvalid*/ Executor executor = PivotUtil.getExecutor(this);
			final /*@NonInvalid*/ IdResolver idResolver = executor.getIdResolver();
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, JuriPackage.Literals.MEMBER___UNIQUE_LOANS__DIAGNOSTICCHAIN_MAP);
			final /*@NonInvalid*/ boolean le = OclComparableLessThanEqualOperation.INSTANCE.evaluate(executor, severity_0, JuriTables.INT_0).booleanValue();
			/*@NonInvalid*/ boolean IF_le;
			if (le) {
				IF_le = true;
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case JuriPackage.MEMBER__LIBRARY:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetLibrary((Library)otherEnd, msgs);
			case JuriPackage.MEMBER__LOAN:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getLoan()).basicAdd(otherEnd, msgs);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case JuriPackage.MEMBER__LOAN:
				return ((InternalEList<?>)getLoan()).basicRemove(otherEnd, msgs);
		}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case JuriPackage.MEMBER__LIBRARY:
				return eInternalContainer().eInverseRemove(this, JuriPackage.LIBRARY__MEMBERS, Library.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case JuriPackage.MEMBER__NAME:
				return getName();
			case JuriPackage.MEMBER__LIBRARY:
				return getLibrary();
			case JuriPackage.MEMBER__LOAN:
				return getLoan();
			case JuriPackage.MEMBER__LOANS:
				return getLoans();
			case JuriPackage.MEMBER__BOOKS:
				return getBooks();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case JuriPackage.MEMBER___AT_MOST_TWO_LOANS__DIAGNOSTICCHAIN_MAP:
				return AtMostTwoLoans((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case JuriPackage.MEMBER___UNIQUE_LOANS__DIAGNOSTICCHAIN_MAP:
