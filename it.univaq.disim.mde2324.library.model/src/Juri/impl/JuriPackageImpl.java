...
import Juri.util.JuriValidator;
 ...
 * @generated
 */
public class JuriPackageImpl extends EPackageImpl implements JuriPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see Juri.JuriPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private JuriPackageImpl() {
		super(eNS_URI, JuriFactory.eINSTANCE);
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *
	 * <p>This method is used to initialize {@link JuriPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static JuriPackage init() {
		if (isInited) return (JuriPackage)EPackage.Registry.INSTANCE.getEPackage(JuriPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredJuriPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		JuriPackageImpl theJuriPackage = registeredJuriPackage instanceof JuriPackageImpl ? (JuriPackageImpl)registeredJuriPackage : new JuriPackageImpl();

		isInited = true;

		// Create package meta-data objects
		theJuriPackage.createPackageContents();

		// Initialize created meta-data
		theJuriPackage.initializePackageContents();
			...
			(theJuriPackage,
			 new EValidator.Descriptor() {
				 ...
				 public EValidator getEValidator() {
					 return JuriValidator.INSTANCE;
				 }
			 });

		// Mark meta-data to indicate it can't be changed
		theJuriPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(JuriPackage.eNS_URI, theJuriPackage);
		return theJuriPackage;
	}
	 ...
	 */
	@Override
	public EReference getMember_Loan() {
	 ...
	 */
	@Override
	public JuriFactory getJuriFactory() {
		return (JuriFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(memberEClass, MEMBER__LOAN);
	...
	public void initializePackageContents() {
		...
		initEReference(getMember_Loan(), this.getLoan(), this.getLoan_Member(), "loan", null, 0, -1, Member.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getLoan_Member(), this.getMember(), this.getMember_Loan(), "member", null, 1, 1, Loan.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
